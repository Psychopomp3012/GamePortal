...
window.addEventListener('load', function() {
    ...
    class Player {
        ...
        draw(ctx) {
            ...
            ctx.strokeStyle = 'white';
            ctx.beginPath();
            ctx.arc(this.x + this.spriteWidth / 2, this.y + this.spriteHeight / 2 + 20, this.spriteWidth / 3, 0, Math.PI * 2);
            ctx.stroke();
        ...
        update(input, deltaTime, enemies) {
            ...
            enemies.forEach((enemy) => {
                ...
                const dx = (enemy.x + enemy.spriteWidth / 2 - 20) - (this.x + this.spriteWidth / 2);
                const dy = (enemy.y + enemy.spriteHeight / 2) - (this.y + this.spriteHeight / 2 + 20);
                const distance = Math.sqrt(dx * dx + dy * dy);

                if (distance < enemy.spriteWidth / 3 + this.spriteWidth / 3) {
    ...
    class Enemy {
        ...
        draw(ctx) {
            ...
            ctx.strokeStyle = 'white';
            ctx.beginPath();
            ctx.arc(this.x + this.spriteWidth / 2 - 20, this.y + this.spriteHeight / 2, this.spriteWidth / 3, 0, Math.PI * 2);
            ctx.stroke();
    ...
    function displayStatusText(ctx) {
        ...
        if (gameOver) {
            ...
            ctx.fillStyle = 'black';
            ctx.fillText('GAME OVER, press Enter or swipe down to restart :D', canvas.width / 2, 200);
            ctx.fillStyle = 'white';
            ctx.fillText('GAME OVER, press Enter or swipe down to restart :D', (canvas.width / 2) + 2, 200 + 2);
    ...
    function toggleFullScreen() {
        ...
        //  built-in read only property on document object
        //  that returns the element that is currently being
        //  presented in full screen mode
...
function tempButtonFunction() {
    ...
    window.location.href = "../../Eighth/eighth.html"
